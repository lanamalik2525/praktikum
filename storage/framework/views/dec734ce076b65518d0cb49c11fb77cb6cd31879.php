    ...
    <div class="container">
        <div class="card mt-4 m-auto" style="width: 50%;">
            <div class="card-body">
                ...
                <div class="form mt-4">
                    <form action="<?php echo e(route('auth.registerStore')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group float-end mt-3">
                            <a href="<?php echo e(route('auth.loginView')); ?>" class="btn btn-success">
                                Back to Login
                            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Software\XAMPP\htdocs\Praktikum_Web2_Laravel\resources\views/register.blade.php ENDPATH**/ ?>